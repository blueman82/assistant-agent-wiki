...
- [[sources/2026-07-24-streaming-relay-wake-channel]] — **wake-channel consumer shipped** (PR #76 merged 2026-07-24): the completion→wake channel (`~/.rachel/wake/`) that lets a detached job start a Rachel turn. The mechanical ticker and answer-first reply remain specified-not-built (Decisions A/B/C/D documented; the completed one is the file-drop wake consumer only). Source spec is gitignored — this page is its only durable home
