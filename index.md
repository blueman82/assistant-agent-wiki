...
- [[capabilities/inbox-brief]] — recommend-only Gmail sweep proactively pushed to Telegram via the standalone `notify.ts` sender; scheduled 4x/day + dashboard button + on-request (PR #23)
